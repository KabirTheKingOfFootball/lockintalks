  ...
  return (
    <MotionShell className="mx-auto grid max-w-7xl gap-8 px-4 py-14 sm:px-6 lg:grid-cols-[1fr_0.7fr] lg:px-8">
      ...
      <div className="grid gap-5">
        <Card><Mail className="mb-4 text-[#d4af37]" /><h2 className="text-xl font-black">Email</h2><p className="mt-2 text-white/62">For support, questions, or competition help, contact <a className="font-bold text-[#d4af37]" href="mailto:lockintalks@gmail.com">lockintalks@gmail.com</a>.</p></Card>
