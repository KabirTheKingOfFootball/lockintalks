...
insert into public.competitions (
  ...
  fee_amount,
  prize_pool_enabled,
  prize_pool_per_paid_participant,
  prize_pool_display_threshold,
  points_enabled,
  summary,
  description,
  status,
...
on conflict (slug) do update set
  ...
  prize_pool_enabled = excluded.prize_pool_enabled,
  prize_pool_per_paid_participant = excluded.prize_pool_per_paid_participant,
  prize_pool_display_threshold = excluded.prize_pool_display_threshold,
